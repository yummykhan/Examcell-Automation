<?php 
		...
		$course="SELECT *  from student inner join course where student.academic_year='$academic_year' AND student.s_dept='$dept' AND student.s_type='$exam_type' AND course.sem='$sem' ";//select query for viewing users.  
...
<body>
		<table>
				...
				<tr>
					...
					$s_seat=" SELECT s_seat_no from student inner join course where student.academic_year='$academic_year' AND student.s_dept='$dept' AND student.s_type='$exam_type' AND course.sem='$sem' AND student.s_name= '".$_SESSION['user']['name']."'  ";
				...
				<tr>
					...
					$s_name="select s_name from student inner join course where student.academic_year='$academic_year' AND student.s_dept='$dept' AND student.s_type='$exam_type' AND course.sem='$sem' AND student.s_name= '".$_SESSION['user']['name']."' ";
